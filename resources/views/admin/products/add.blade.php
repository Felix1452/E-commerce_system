            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="number" name="quantity" value="{{ old('quantity') }}"  min="0" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Mô Tả </label>
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <textarea style="height: 280px" class="form-control" name="systemConfig">{{ old('systemConfig') }}</textarea>
                    </div>
                </div>
            </div>
